...
public class Level21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.leveltwentyone);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level21.this, GameLevels.class);// Создали намерение для перехода
        ...
        img_left.setImageResource(array.images21[numLeft]);// Достаем из массива картинку
