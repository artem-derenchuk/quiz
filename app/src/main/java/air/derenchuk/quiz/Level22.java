...
public class Level22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.leveltwentytwo);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level22.this, GameLevels.class);// Создали намерение для перехода
        ...
        textdescriptionEnd.setText(R.string.leveltwentyoneEnd);
        ...
        img_left.setImageResource(array.images22[numLeft]);// Достаем из массива картинку
