...
public class Level23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.leveltwentythree);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level23.this, GameLevels.class);// Создали намерение для перехода
        ...
        textdescriptionEnd.setText(R.string.leveltwentythreeEnd);
        ...
        img_left.setImageResource(array.images23[numLeft]);// Достаем из массива картинку
