...
public class Level25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.leveltwentyfive);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level25.this, GameLevels.class);// Создали намерение для перехода
        ...
        img_left.setImageResource(array.images25[numLeft]);// Достаем из массива картинку
