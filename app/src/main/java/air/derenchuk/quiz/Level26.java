...
public class Level26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.leveltwentysix);
        ...
        textdescriptionEnd.setText(R.string.leveltwentysixEnd);
        ...
        img_left.setImageResource(array.images26[numLeft]);// Достаем из массива картинку
