...
public class Level27 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.leveltwentyseven);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level27.this, GameLevels.class);// Создали намерение для перехода
        ...
        textdescriptionEnd.setText(R.string.leveltwentysevenEnd);
        ...
        img_left.setImageResource(array.images27[numLeft]);// Достаем из массива картинку
