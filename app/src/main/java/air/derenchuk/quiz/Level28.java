...
public class Level28 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.leveltwentyeight);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level28.this, GameLevels.class);// Создали намерение для перехода
        ...
        textdescriptionEnd.setText(R.string.leveltwentyeightEnd);
        ...
        img_left.setImageResource(array.images28[numLeft]);// Достаем из массива картинку
