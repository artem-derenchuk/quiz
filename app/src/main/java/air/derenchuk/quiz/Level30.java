...
public class Level30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textdescription.setText(R.string.levelthirty);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level30.this, GameLevels.class);// Создали намерение для перехода
        ...
        textdescriptionEnd.setText(R.string.levelthirtyEnd);
        ...
        img_left.setImageResource(array.images30[numLeft]);// Достаем из массива картинку
